    ...
    b.extend(b.jgrid, {
        ...
        parseDate: function (f, e) {
            ...
            if (e && null !== e && void 0 !== e) {
                ...
                d = 0;
                for (a = f.length; d < a; d++) "M" == f[d] && (h = b.inArray(e[d], g), -1 !== h && 12 > h && (e[d] = h + 1, c.m = e[d])), "F" == f[d] && (h = b.inArray(e[d], g), -1 !== h && 11 < h && (e[d] = h + 1 - 12, c.m = e[d])), "a" == f[d] && (h = b.inArray(e[d], i), -1 !== h && 2 > h && e[d] == i[h] && (e[d] = h, c.h = j(e[d], c.h))), "A" == f[d] && (h = b.inArray(e[d], i), -1 !== h && 1 < h && e[d] == i[h] && (e[d] = h - 2, c.h = j(e[d], c.h))), void 0 !== e[d] && (c[f[d].toLowerCase()] = parseInt(e[d], 10));
        ...
        from: function (f) {
            return new function (e, c) {
                ...
                var d = this,
                    ...
                    v = [],
                    u = !0;
                if ("object" == typeof e && e.push) 0 < e.length && (u = "object" != typeof e[0] ? !1 : !0);
                ...
                this.endsWith = function (a, c) {
                    var h = void 0 === c || null === c ? a : c,
                        h = f ? b.trim(h.toString()).length : h.toString().length;
                    u ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + h + "," + h + ') == "' + d._toStr(c) + '"') : d._append(d._getStr("this") + ".substr(" + d._getStr("this") + '.length-"' + d._toStr(a) + '".length,"' + d._toStr(a) + '".length) == "' + d._toStr(a) + '"');
                        ...
                        populateVisible: function () {
                            ...
                            if (a) {
                                ...
                                if (G) {
                                    ...
                                    G *= i;
                                    var y, z, B;
                                    if (k < a && 0 >= j && (void 0 === d.lastpage || parseInt((k + f + G - 1) / G, 10) <= d.lastpage)) z = parseInt((a - k + G - 1) / G, 10), 0 <= k || 2 > z || !0 === d.scroll ? (y = Math.round((k + f) / G) + 1, j = -1) : j = 1;
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var o = function (a, b) {
                            ...
                            p = function (d, e, f, g, i, j) {
                                ...
                                else if (K.cellattr && b.isFunction(K.cellattr)) if ((d = K.cellattr.call(a, i, f, g, K, j)) && typeof d === "string") {
                            ...
                            $ = function (c, d, e, f, g) {
                                ...
                                if (b.isXMLDoc(c)) {
                                    ...
                                    if (a.p.gridview === true) {
                                        ...
                                        if (a.p.grouping) {
                                            b(a).jqGrid("groupingRender", Q, a.p.colModel.length);
                                            Q = null
                            ...
                            I = function (c) {
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    var q = !a.p.scroll ? 1 : a.rows.length - 1,
                        ...
                        for (e = 0; e < this.p.colNames.length; e++) L = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[e]) + '"' : "", x += "<th id='" + a.p.id + "_" + a.p.colModel[e].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + i + "'" + L + ">", L = a.p.colModel[e].index || a.p.colModel[e].name, x += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[e].name + "' " + la + ">" + a.p.colNames[e], a.p.colModel[e].width = a.p.colModel[e].width ? parseInt(a.p.colModel[e].width, 10) : 150, "boolean" !== typeof a.p.colModel[e].title && (a.p.colModel[e].title = !0), L == a.p.sortname && (a.p.lastsort = e), x += W + "</div></th>";
                        W = null;
                        ...
                        if (this.p.multiselect) {
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
                                ...
                                b.isFunction(a.p.onSelectAll) && a.p.onSelectAll.call(a, X ? a.p.selarrrow : ga, X)
                            })
                        ...
                        var Y = null,
                            j = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(x),
                        ...
                        b(a).before(c.hDiv).click(function (c) {
                            ...
                            if (b(n).length !== 0) {
                                t = n[0].rowIndex;
                                E = b.jgrid.getCellIndex(A);
                                b(a).triggerHandler("jqGridDblClickRow", [b(n).attr("id"), t, E, c]);
                        ...
                        b(c.cDiv).append(ia).append("<span class='ui-jqgrid-title" + ("rtl" == i ? "-rtl" : "") + "'>" + a.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
                        ...
                        a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], e = b("<div class='ui-jqgrid-hbox" + ("rtl" == i ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(e).insertAfter(c.hDiv).width(c.width), b(e).append(R), c.footers = b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"), D && b(c.sDiv).hide());
                        e = null;
                        if (a.p.caption) {
                            var pa = a.p.datatype;
        ...
        getRowData: function (f) {
            ...
            this.each(function () {
                ...
                for (; h < a;) d && (j = g.rows[h]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function (a) {
                    ...
                    if ("cb" !== i && "subgrid" !== i && "rn" !== i) if (!0 === g.p.treeGrid && i == g.p.ExpandColumn) e[i] = b.jgrid.htmlDecode(b("span:first", this).html());
                    else try {
            ...
            this.each(function () {
                ...
                if (e) try {
                    if (b(this.p.colModel).each(function (a) {
                        d = this.name;
                        void 0 !== e[d] && (k[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ? b.unformat.date.call(g, e[d], this) : e[d], i = g.formatter(f, e[d], a, e, "edit"), h = this.title ? {
                ...
                if (this.grid) {
                    ...
                    if (!isNaN(f)) {
                        ...
                        if (!0 === e) {
                            ...
                            c.p.tblwidth > f ? (j = c.p.tblwidth - parseInt(f, 10), c.p.tblwidth = f, d = c.p.colModel[g].width -= j) : d = c.p.colModel[g].width;
            ...
            return this.each(function () {
                ...
                if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {
                    ...
                    if ("" !== c || !0 === h) i = this.formatter(f, c, g, i, "edit"), j = this.p.colModel[g].title ? {
                        title: b.jgrid.stripHtml(i)
                    } : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(l)).length ? b("span", b(l)).html(i).attr(j) : b(l).html(i).attr(j), "local" == this.p.datatype && (i = this.p.colModel[g], c = i.formatter && "string" === typeof i.formatter && "date" == i.formatter ? b.unformat.date.call(this, c, i) : c, j = this.p._index[f], "undefined" != typeof j && (this.p.data[j][i.name] = c));
                    ...
                    if (k && 0 < k) {
                        for (; m < k;) {
                            if (b(this.rows[m]).hasClass("jqgrow")) {
                                ...
                                c ? (j = parseFloat(a), h += j, 0 === m ? i = g = j : (g = Math.min(g, j), i = Math.max(i, j))) : e ? d.push({
                                    id: this.rows[m].id,
                                    value: a
                                }) : d.push(a)
                            }
...
(function (c) {
    ...
    c.fmatter.util = {
        ...
        DateFormat: function (a, b, f, d) {
            var e = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/,
                g = "string" === typeof b ? b.match(e) : null,
                e = function (a, b) {
                    a = "" + a;
            ...
            return f.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g, function (a) {
    ...
    c.fn.fmatter.link = function (a, b) {
        ...
        return !c.fmatter.isEmpty(a) ? "<a " + d + ' href="' + a + '">' + a + "</a>" : c.fn.fmatter.defaultFormat(a, b)
    };
    c.fn.fmatter.showlink = function (a, b) {
        ...
        return c.fmatter.isString(a) || c.fmatter.isNumber(a) ? "<a " + d + ' href="' + f + '">' + a + "</a>" : c.fn.fmatter.defaultFormat(a, b)
    };
    ...
    c.fn.fmatter.date = function (a, b, f, d) {
        f = c.extend({}, b.date);
        void 0 !== b.colModel && !c.fmatter.isUndefined(b.colModel.formatoptions) && (f = c.extend({}, f, b.colModel.formatoptions));
        return !f.reformatAfterEdit && "edit" == d || c.fmatter.isEmpty(a) ? c.fn.fmatter.defaultFormat(a, b) : c.fmatter.util.DateFormat(f.srcformat, a, f.newformat, f)
    };
    ...
    c.fn.fmatter.rowactions = function (a, b, f, d) {
        ...
        c.fmatter.isUndefined(c("#" + b)[0].p.editOptions) || (e.editOptions = c("#" + b)[0].p.editOptions);
        ...
        case "edit":
            ...
            break;
        case "save":
            c("#" + b).jqGrid("saveRow", a, h) && (c("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + b + ".ui-jqgrid-btable:first").show(), c("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + b + ".ui-jqgrid-btable:first").hide(), c(g).triggerHandler("jqGridAfterGridComplete"));
            break;
        case "cancel":
        ...
        case "del":
            ...
            break;
        case "formedit":
            c("#" + b).jqGrid("setSelection", a), c("#" + b).jqGrid("editGridRow", a, e.editOptions)
        }
    };
    ...
    c.unformat.select = function (a, b, f, d) {
        ...
        var d = c.extend({}, !c.fmatter.isUndefined(b.colModel.formatoptions) ? b.colModel.formatoptions : b.colModel.editoptions),
            b = void 0 === d.separator ? ":" : d.separator,
...
(function (a) {
    a.extend(a.jgrid, {
        ...
        createModal: function (d, b, c, f, g, h, i) {
            ...
            if (c.resize) if (a.fn.jqResize) a(e).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se ui-icon-grip-diagonal-se'></div>"), a("#" + a.jgrid.jqID(d.themodal)).jqResize(".jqResize", d.scrollelm ? "#" + a.jgrid.jqID(d.scrollelm) : !1);
            else try {
                a(e).resizable({
                    handles: "se, sw",
...
(function (a) {
    ...
    a.jgrid.extend({
            ...
            return this.each(function () {
                        ...
                        v = a.extend({
                            ...
                            complete: function (g, n) {
                                ...
                                if (f[0] === false) {
                                    ...
                                    i = a.extend(i, B);
                                    b.p.autoencode && a.each(i, function (b, d) {
                ...
                if (b.grid && u) {
                    ...
                    if (null !== a("#" + a.jgrid.jqID(o.themodal)).html()) {
                        ...
                        !0 === d.saveicon[0] && a("#sData", j + "_2").addClass("right" == d.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.saveicon[2] + "'></span>");
        ...
        viewGridRow: function (c, d) {
            ...
            return this.each(function () {
                function e() {
                    (!0 === d.closeOnEscape || !0 === d.navkeys[0]) && setTimeout(function () {
                ...
                if (!this.nav) {
                    ...
                    if (g.grid && "string" == typeof c) {
                        ...
                        for (var w = 0; w < n; w++) {
                            ...
                            d.add && (l = l || {}, f = a("<td class='ui-pg-button ui-corner-all'></td>"), a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.addicon + "'></span>" + d.addtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.addtitle || "",
                                id: l.id || "add_" + h
                            }).click(function () {
                            ...
                            d.search && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.searchtitle || "",
                                id: t.id || "search_" + h
                            }).click(function () {
                ...
                if (n) {
                    ...
                    this.createTableForGroup = function (g, k) {
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            var h = "",
                                f;
                            for (c = 0; c < o.groupOps.length; c++) f = g.groupOp === b.p.groupOps[c].op ? " selected='selected'" : "", h += "<option value='" + b.p.groupOps[c].op + "'" + f + ">" + b.p.groupOps[c].text + "</option>";
                    ...
                    this.createTableRowForRule = function (g, d) {
                        ...
                        n.bind("change", function () {
                            ...
                            if (i) {
                                ...
                                for (e = 0; e < f.length; e++) p = a.inArray(f[e], q), -1 !== p && (0 === k && (g.op = b.p.ops[p].name), d += "<option value='" + b.p.ops[p].name + "'>" + b.p.ops[p].description + "</option>", k++);
...
(function (a) {
    ...
    a.jgrid.extend({
            ...
            return this.each(function () {
                ...
                b.grid && (m = a(b).jqGrid("getInd", c, !0), !1 !== m && (e = a(m).attr("editable") || "0", "0" == e && !a(m).hasClass("not-editable-row") && (n = b.p.colModel, a('td[role="gridcell"]', m).each(function (e) {
                    ...
                    if ("cb" != f && ("subgrid" != f && "rn" != f) && (b.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[f] = d, !0 === n[e].editable)) {
                        ...
                        k = a.jgrid.createEl.call(b, n[e].edittype, k, d, !0, a.extend({}, a.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {}));
                    ...
                    if (27 === e.keyCode) {
                        a(b).jqGrid("restoreRow", c, j.afterrestorefunc);
        ...
        saveRow: function (c, b, d, k, g, l, p) {
            ...
            else if (a.isFunction(b) && (f.successfunc = b), "undefined" !== typeof d && (f.url = d), "undefined" !== typeof k && (f.extraparam = k), a.isFunction(g) && (f.aftersavefunc = g), a.isFunction(l) && (f.errorfunc = l), a.isFunction(p)) f.afterrestorefunc = p;
            var f = a.extend(!0, {
                successfunc: null,
                url: null,
                extraparam: {},
            ...
            if ("1" === h) {
                ...
                if ("clientArray" == f.url) {
                    ...
                    url: f.url,
                    data: a.isFunction(e.p.serializeRowData) ? e.p.serializeRowData.call(e, r) : r,
                    type: f.mtype,
                    async: !1,
                    complete: function (b, d) {
                        ...
                        if (d === "success") {
                            ...
                            if (g === true) {
                                ...
                                a(q).attr("editable", "0");
                                for (g = 0; g < e.p.savedRow.length; g++) if (e.p.savedRow[g].id == c) {
                                    t = g;
                                    break
                                }
        ...
        restoreRow: function (c, b) {
            var d = a.makeArray(arguments).slice(1),
                k = {};
            "object" === a.type(d[0]) ? k = d[0] : a.isFunction(b) && (k.afterrestorefunc = b);
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    !0 === b.restoreAfterSelect && (k = a.isFunction(d.p.beforeSelectRow) ? d.p.beforeSelectRow : !1, d.p.beforeSelectRow = function (c, f) {
                        var g = true;
                        if (d.p.savedRow.length > 0 && d.p._inlinenav === true && c !== d.p.selrow && d.p.selrow !== null) {
...
(function (b) {
    ...
    b.jgrid.extend({
        ...
        groupingPrepare: function (a, d, e, f) {
            this.each(function () {
                for (var c = this.p.groupingView, h = this, g = c.groupField.length, k, j, p = 0, i = 0; i < g; i++) k = c.groupField[i], j = e[k], void 0 !== j && (0 === f ? (c.groups.push({
                    idx: i,
                    dataIndex: k,
                    value: j,
                    startRow: f,
        ...
        groupingToggle: function (a) {
            this.each(function () {
                ...
                if (k.hasClass(c)) {
                    ...
                    if (g) for (; g && !b(g).hasClass(e + "_" + ("" + f)) && !b(g).hasClass(e + "_" + ("" + (f - 1)));) b(g).show(), g = g.nextSibling;
        ...
        groupingRender: function (a, d) {
            return this.each(function () {
                ...
                b.each(c.groups, function (r, l) {
                    ...
                    h += '<tr id="' + k + '" role="row" class= "ui-widget-content jqgroup ui-row-' + f.p.direction + " " + j + '"><td style="padding-left:' + 12 * l.idx + 'px;" colspan="' + d + '">' + g + b.jgrid.template(c.groupText[l.idx], i, l.cnt, l.summary) + "</td></tr>";
                    if (x - 1 === l.idx) {
                        ...
                        for (m = 0; m < s; m++) if (y[m]) {
                            ...
                            h += "<tr" + o + ' role="row" class="ui-widget-content jqfoot ui-row-' + f.p.direction + '">';
        ...
        setTreeGrid: function () {
            return this.each(function () {
                ...
                if (a.p.treeGrid) {
                    ...
                    a.p.rowList = [];
                    a.p.expColInd = 0;
                    b = "ui-icon-triangle-1-" + ("rtl" == a.p.direction ? "w" : "e");
