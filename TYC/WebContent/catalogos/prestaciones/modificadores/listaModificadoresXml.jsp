...
<respuestaXML>
    ...
    <filas>
        <c:forEach items="${requestScope.listaModificadores}" var="modificador">
            <fila>
            	<idModificador>${modificador.nIdCatalogoModificador}</idModificador>
            	<idCatPrestacion>${modificador.nIdCatalogoPrestacion}</idCatPrestacion>
            	<tipo>${modificador.sDesCodTipo}</tipo>
