...
function Timepicker() {
	...
	this.regional[''] = { // Default regional settings
		currentText: 'Hora Actual',//'Now',
		closeText: 'Listo', //'Done',
		ampm: false,
		amNames: ['AM', 'A'],
		pmNames: ['PM', 'P'],
		timeFormat: 'hh:mm tt',
		timeSuffix: '',
		timeOnlyTitle: 'Seleccione Hora',//'Choose Time',
		timeText: 'Reloj',//'Time',
		hourText: 'Hora',//'Hour',
		minuteText: 'Minuto',//'Minute',
		secondText: 'Segundos',//'Second',
		millisecText: 'Milisegundos',//'Millisecond',
